...
var FW = {
	...
	updateLayout: function(){
		...
		if(mode_names === "face_display_for_observer-stt"){
			$('#face_display_for_observer')
				.attr('class', 'col-md-7 column');
			$('canvas')
				.attr('class', 'col-md-6 column');
			...
			$("#face_display_for_observer").after($("#stt"));

			return;
		}

		if(mode_names === "face_display_for_observer-image_search-stt"){
			$('#face_display_for_observer')
				.attr('class', 'col-md-7 column');
			$('canvas')
				.attr('class', 'col-md-6 column');
			...
			$("#face_display_for_observer").after($("#image_search")).after($("#stt"));

			return;
		}

		if(mode_names === "dictionary-face_display_for_observer-stt"){
			$('#face_display_for_observer')
				.attr('class', 'col-md-7 column');
			$('canvas')
				.attr('class', 'col-md-6 column');
			...
			$("#face_display_for_observer").after($("#dictionary")).after($("#stt"));

			return;
		}

		if(mode_names === "dictionary-face_display_for_observer-image_search-stt"){
			$('#face_display_for_observer')
				.attr('class', 'col-md-7 column');
			$('canvas')
				.attr('class', 'col-md-6 column');
			...
			$("#face_display_for_observer").after($("#dictionary")).after($("#image_search")).after($("#stt"));

			return;
		}

		if(mode_names === "script_publish_as_stt-stt"){
			$('#stt')
				.attr('class', 'col-md-6 column');
			$('#script_publish_as_stt')
				.attr('class', 'col-md-6 column');
		...
		if(mode_names === "face_display_for_speaker-script_publish_as_stt-stt"){
			$('#stt')
				.attr('class', 'col-md-4 column');
			$('#script_publish_as_stt')
				.attr('class', 'col-md-4 column');
		...
		if(mode_names === "face_display_for_speaker-stt"){
			$('#stt')
				.attr('class', 'col-md-6 column');
			$('#face_display_for_speaker')
				.attr('class', 'col-md-6 column');
