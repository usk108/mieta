...
var mode_image_search = {
	...
	run : function() {
		...
		var CUSTOM_SEARCH_ENGINE_ID = 'YOUR CUSTOM SEARCH ENGINE ID';
        var image_search_url = 'https://www.googleapis.com/customsearch/v1?key=' + API_KEY + '&cx=' + CUSTOM_SEARCH_ENGINE_ID + '013619658451633440601:nmmf6rj1hsc&searchType=image&q=' + this.target_word;
        var self = this;
        $.ajax({
            type: "get",
            dataType: "jsonp",
